* File name: c_1_Fig5.1_paperFig4A_update.do
...
quietly{
	...
	foreach x of local vars{
		...
		preserve
			...
			sort tvar
			if `m'==1{
				export excel using "`outputFolder'/c_1_Fig5.1_paperFig4A_update.xlsx", sheet("`x'") firstrow(varlabel) replace
			}
			else{
				export excel using "`outputFolder'/c_1_Fig5.1_paperFig4A_update.xlsx", sheet("`x'") firstrow(varlabel)
			}
