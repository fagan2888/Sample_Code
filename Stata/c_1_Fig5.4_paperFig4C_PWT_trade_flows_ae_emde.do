* File name: c_1_Fig5.4_paperFig4C_PWT_trade_flows
	...
	foreach g of local group{
		...
		foreach x of local vars{
			...
			preserve
				...
				sort tvar
				if `m'==1{
					export excel using "`outputFolder'/c_1_Fig5.4_paperFig4C_PWT_trade_flows_`g'.xlsx", sheet("`x'") firstrow(varlabel) replace
				}
				else{
					export excel using "`outputFolder'/c_1_Fig5.4_paperFig4C_PWT_trade_flows_`g'.xlsx", sheet("`x'") firstrow(varlabel)
				}
