* File name: c_1_Fig2.1B_paperFig1B_update_WEO.do
* Description: use Nao's data to update figure 2.1.B
* Author: Shijie Shi
...
quietly{
	...
	* 1. Get the country list from Nao's data
	...
	* 1.2 Read in data from WEO
	...
	n merge m:1 ccode using `countryList' //this step restricts the sample size
	keep if _merge==3
	drop _merge
	...
	export excel using "`outputFolder'/c_1_Fig2.1B_paperFig1B_update_WEO.xlsx", firstrow(variables) replace	
}
