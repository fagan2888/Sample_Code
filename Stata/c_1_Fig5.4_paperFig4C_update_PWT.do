* File name: c_1_Fig5.4_paperFig4C_update_PWT.do
		...
		********************************
		...
		foreach x of local vars{
			...
			preserve
				...
				if `m'==1{
					export excel using "`outputFolder'/c_1_Fig5.4_paperFig4C_update_PWT.xlsx", sheet("`gr'_`x'") firstrow(varlabel) replace
				}
				else{
					export excel using "`outputFolder'/c_1_Fig5.4_paperFig4C_update_PWT.xlsx", sheet("`gr'_`x'") firstrow(varlabel)
				}
