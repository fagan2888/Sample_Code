...
quietly{
	...
	* 3. Read in the population growth data calculated with constraining the samples with gdpsa and pppwt 
	import excel using "`outputFolder'/`date'_1_compare_gdp_5_population_mm.xlsx", firstrow clear
	...
	*tsline count*
	...
	export excel using "`outputFolder'/`date'_1_compare_gdp_6_population_weo_wdi_mm.xlsx", firstrow(variables) replace
}
