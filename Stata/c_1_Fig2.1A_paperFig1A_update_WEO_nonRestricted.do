* File name: c_1_Fig2.1A_paperFig1A_update_WEO_nonRestricted.do
* Description: use WEO data to update figure 2.1.A
* Author: Shijie Shi
...
quietly{
	...
	* 2. Aggregate GDP for AEs and EMDEs
	...
	export excel using "`outputFolder'/c_1_Fig2.1A_paperFig1A_update_WEO_nonRestricted.xlsx", firstrow(variables) replace	
}
