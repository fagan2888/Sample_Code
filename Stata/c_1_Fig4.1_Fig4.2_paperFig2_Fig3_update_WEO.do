* File name: c_1_Fig4.1_Fig4.2_paperFig2_Fig3_update_WEO.do
* Description: use WEO data to update figure 4.1.
* Author: Shijie Shi
...
*/	
	...
	* Per capita variables
	...
	export excel using "`outputFolder'/c_1_Fig4.1_Fig4.2_paperFig2_Fig3_update_WEO.xlsx", firstrow(varlabels) replace	
}
