* File name: c_1_Fig2.1A_paperFig1A_update_PWT_nonRestricted.do
* Description: use PWT data to update figure 2.1.A
* Author: Shijie Shi
...
quietly{
	...
	* 2. Aggregate GDP for AEs and EMDEs
	...
	export excel using "`outputFolder'/c_1_Fig2.1A_paperFig1A_update_PWT_nonRestricted.xlsx", firstrow(variables) replace	
}
