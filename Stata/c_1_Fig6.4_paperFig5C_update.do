* File name: c_1_Fig6.4_paperFig5C_update.do
	...
	foreach file of local files{
		...
		foreach x of local vars{
			...
			preserve
				...
				if `m'==1{
					export excel using "`outputFolder'/c_1_Fig6.4_paperFig5C_update.xlsx", sheet("`gr'_`x'") firstrow(varlabel) replace
				}
				else{
					export excel using "`outputFolder'/c_1_Fig6.4_paperFig5C_update.xlsx", sheet("`gr'_`x'") firstrow(varlabel)
				}
