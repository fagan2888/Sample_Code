...
quietly{;
	...
	** Unweighted **;
	...
	export excel using "output\c_1_Fig7_paperFig6_update_WEO.xlsx", sheet("unwt_recess") firstrow(varlabel) datestring("%ty") replace;
	...
	** Weighted **;
	...
	export excel using "output\c_1_Fig7_paperFig6_update_WEO.xlsx", sheet("wt_recess") firstrow(varlabel) datestring("%ty");
