...
quietly{;
	...
	* Manually adjust AE and EMDE category;
	...
	rename (pppgdp lp) (pppwgt population);
...
ddddddddd
	...
	** Unweighted **;
	...
	export excel using "output\c_1_Fig7_paperFig6_update_WEO_nonRestricted.xlsx", sheet("unwt_recess") firstrow(varlabel) datestring("%ty") replace;
	...
	** Weighted **;
	...
	export excel using "output\c_1_Fig7_paperFig6_update_WEO_nonRestricted.xlsx", sheet("wt_recess") firstrow(varlabel) datestring("%ty");
