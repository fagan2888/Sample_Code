* File name: c_1_Fig6.1_paperFig5A_update_PWT.do
...
quietly{
	...
	foreach x of local vars{
		...
		preserve
			...
			sort tvar
			if `m'==1{
				export excel using "`outputFolder'/c_1_Fig6.1_paperFig5A_update_PWT.xlsx", sheet("`x'") firstrow(varlabel) replace
			}
			else{
				export excel using "`outputFolder'/c_1_Fig6.1_paperFig5A_update_PWT.xlsx", sheet("`x'") firstrow(varlabel)
			}
