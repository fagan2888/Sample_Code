* File name: c_1_Fig4.1_Fig4.2_paperFig2_Fig3_update_WDI_constSamples_nonRestricted_datasetForR
	...
	*** Prepare datasets to calculate PPP weights
	...
	foreach var in "ngdpr" "lp" "pppgdp"{
		preserve
			...
			export delimited using "output/c_1_fig3_WDI_pppweight_`var'_nonRestricted.csv", replace
		restore
	}
}	
